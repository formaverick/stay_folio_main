			...
			<div>
				...
				<p class="reserv-day">
					<fmt:formatDate value="${reservation.srCheckin}"
						pattern="yyyy.MM.dd" />
					~
					<fmt:formatDate value="${reservation.srCheckout}"
						pattern="yyyy.MM.dd" />
				...
				<p class="reserv-option" style="margin-top: 1rem; color: #666">
					...
					/ 기준 ${reservation.riPerson}명 (최대 ${reservation.riMaxperson}명)
				</p>
			</div>
		</div>
	...
	<div class="reservation-status">
		...
		<div class="status-steps">
			<div class="step step-01">
				...
				<p class="step-desc">예약 신청이 완료되었으며, 호스트의 예약 확정 대기 상태입니다.</p>
			</div>
	...
	<div class="reservation-detail-section">
		...
		<table class="reservation-info-table">
			...
			<tr>
				...
				<td class="reservation-info-content">총 ${reservation.srAdult + reservation.srChild}명
					(성인: ${reservation.srAdult}명 / 아동: ${reservation.srChild}명)</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="reservation-info-content"><c:choose>
        ...
        요청사항 없습니다.
			...
			<tr>
				...
				<td class="reservation-info-content">숙박자의 체류목적, 일정, 인원, 교통편
					조정합니다. 예약자의 사전 동의 없이는 체류 목적 외 방문, 인원 변경 등이 불가능합니다.</td>
			</tr>
		</table>
	</div>
	...
	<div class="reservation-detail-section">
		...
		<table class="payment-info-table">
			...
			<tr>
				...
				<td class="reservation-info-content">${reservation.srPayment}
					(결제 완료: <fmt:formatDate value="${reservation.srPaydate}"

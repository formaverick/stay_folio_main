...
function showWishlistMessage(message, type) {
  ...
  const messageClass =
    type === "add" ? "wishlist-message-add" : "wishlist-message-remove";
  const $message = $(`
  ...
  return `
    <div class="stay-card" data-stay-id="${stay.id}">
      <div class="stay-card-image">
        ...
        ${promotionTag}
        <button class="stay-card-wishlist ${wishlistClass}" data-wishlist="${
    stay.isWishlisted
  }">

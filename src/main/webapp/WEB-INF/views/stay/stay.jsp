...
<html lang="ko">
  <head>
    ...
    <script
      ...
      src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=23c99c1ca832c53450f37e55c5731901&libraries=services"
    ></script>
    ...
    <section class="carousel-container">
      ...
      <div class="carousel">
        ...
        <div class="carousel-indicators">
          <c:forEach var="photo" items="${stayPhotos.main}" varStatus="status">
            <button
              class="indicator ${status.first ? 'active' : ''}"
              data-slide="${status.index}"
            ></button>
          </c:forEach>
          <c:forEach
            var="photo"
            items="${stayPhotos.additional}"
            varStatus="status"
          >
            <button
              class="indicator"
              data-slide="${status.index + stayPhotos.main.size()}"
            ></button>
          </c:forEach>
          <c:forEach
            var="photo"
            items="${stayPhotos.feature}"
            varStatus="status"
          >
            <button
              class="indicator"
              data-slide="${status.index + stayPhotos.main.size() + stayPhotos.additional.size()}"
            ></button>
          </c:forEach>
        </div>
      </div>
            ...
            <c:forEach var="room" items="${rooms}">
              <div class="room-card">
                <div class="room-image">
                  <img
                    src="${s3BaseUrl}${roomMainPhotos[room.riId].spUrl}"
                    alt="${room.riName}"
                  />
                </div>
                <div class="room-info">
                  ...
                  <p class="room-amenity">
                    침실 ${room.riBedroom} | 침대 ${room.riBedcnt} | 욕실
                    ${room.riBathroom}
                  </p>
                  ...
                  <div class="room-price-container">
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        <button
                          class="room-select-btn disabled"
                          disabled

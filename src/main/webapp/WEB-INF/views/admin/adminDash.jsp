          ...
          <div class="header-content">
            <div class="header-left">
              ...
              <p class="page-subtitle">
                예약 현황, 숙소 등록 상태, 통계 정보를 빠르게 확인하세요.
              </p>
            </div>
            <div class="header-right">
              <a href="${pageContext.request.contextPath}/" class="btn-save"
                >MAIN PAGE</a
              >
            </div>
          </div>
          ...
          <div class="room-table-container">
            <table class="room-table">
              ...
              <tbody>
                <c:forEach
                  var="stay"
                  items="${topReservedStays}"
                  varStatus="loop"
                >
                  <tr>
                    <td>${loop.index + 1}</td>
                    <td>
                      <a href="/admin/stay/detail?siId=${stay.siId}"
                        >${stay.siName}</a
                      >
                    </td>
                    <td>${stay.siLoca}</td>
                ...
                <tbody>
                  <c:forEach var="stay" items="${stayList}">
                    <tr>
                      ...
                      <td>
                        <a
                          href="/admin/stay/detail?siId=${stay.siId}"
                          class="btn-edit"
                          >상세보기</a
                        >
                      </td>

			...
			<div class="admin-header">
				<div class="header-content">
					...
					<div class="header-right" style="display: flex; gap: 1rem">
						<form action="/admin/stay/detail" method="get" style="display: inline-block; margin-right: 1rem">
						...
						<tbody>
							<c:forEach var="room" items="${roomList}">
								<tr>
									...
									<td>
										<a href="/admin/room/detail?siId=${room.siId}&riId=${room.riId}" class="btn-edit">상세보기</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>

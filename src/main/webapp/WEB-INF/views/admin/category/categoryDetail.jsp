...
<html lang="ko">
  <head>
    <meta charset="UTF-8" />
    <title>카테고리 상세 - STAY FOLIO ADMIN</title>
          ...
          <div class="header-content">
            ...
            <div class="header-right">
              <div style="display: inline-block; margin-right: 1rem">
                <a
                  href="${pageContext.request.contextPath}/admin/category/form?rcId=${category.rcId}"
                  class="btn-save"
                  >수정하기</a
                >
              </div>
              ...
              <div style="display: inline-block">
                <a href="/admin/dashboard#category-section" class="btn-save"
                  >뒤로가기</a
                >
              </div>
            </div>
                        ...
                        <div class="recommend-price">
                          <c:choose>
                            <c:when test="${stay.siDiscount > 0}">
                              <span class="recommend-price-original">
                                ₩<fmt:formatNumber
                              ...
                              <span class="recommend-price-current">
                                <span class="recommend-price-discount">
                                  <fmt:formatNumber
                                    value="${stay.siDiscount * 100}"
                                    type="number"
                                    maxFractionDigits="0"
                                  />%
                                </span>

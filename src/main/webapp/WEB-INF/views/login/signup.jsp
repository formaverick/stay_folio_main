	...
	<main class="signup-main">
		<div class="signup-page">
			...
			<div class="signup-section active" id="combined-section">
				<form class="signup-form" id="combined-form" method="post" action="${pageContext.request.contextPath}/register">
					<div class="form-group">
						<label for="email">이메일</label>
						<input type="email" id="email" name="miId" placeholder="이메일을 입력해주세요." required />
						<p class="error-message"></p>
					</div>

					<div class="form-group">
						<label for="password">비밀번호</label>
						<input type="password" id="password" name="miPw" placeholder="비밀번호를 입력해주세요." required />
						<p class="error-message"></p>
					</div>

					<div class="form-group">
						<label for="name">이름</label>
						<input type="text" id="name" name="miName" placeholder="이름을 입력해주세요." required />
						<p class="error-message"></p>
					</div>

					<div class="form-group">
						<label for="phone">전화번호</label>
						<input type="tel" id="phone" name="miPhone" placeholder="전화번호를 입력해주세요." required />
						<p class="error-message"></p>
					</div>
					...
					<div class="checkbox-group toggle-box required">
						...
						<div class="terms-box">
							<div class="terms-content">
								...
								<p>본 약관은 스테이폴리오에서 제공하는 모든 서비스 이용에 적용됩니다.</p>
								<p>
									<strong>제1조 (목적)</strong><br />이 약관은 회사가 제공하는 서비스 이용자의 권리·의무 및
									책임사항을 규정합니다.
								</p>
								<p>
									<strong>제2조 (정의)</strong><br />"플랫폼"이란 회사가 운영하는 온라인 서비스 일체를
									말합니다.
								</p>
							</div>
						</div>
					...
					<div class="checkbox-group toggle-box required">
						...
						<div class="terms-box">
							<div class="terms-content">
								...
								<p>1. 수집항목: 성명, 연락처, 이메일, 생년월일, 성별, 결제정보</p>
								<p>2. 수집목적: 회원관리, 서비스 제공, 고객상담, 마케팅 및 광고 활용</p>
					...
					<div class="checkbox-group toggle-box required">
						...
						<div class="terms-box">
							<div class="terms-content">
								<p>본 서비스는 만 14세 미만의 아동에게는 제공되지 않습니다.</p>
								<p>만 14세 미만 아동의 개인정보 수집 시 법정대리인의 동의가 필요합니다.</p>
								<p>만 14세 미만 아동이 본 서비스를 이용하기 위해서는 법정대리인의 동의가 필요합니다.</p>
							</div>
						</div>
					</div>
					...
					<div class="checkbox-group toggle-box">
						<div class="toggle-header">
							...
							<label for="terms4">(선택) 쿠폰, 이벤트 등 혜택 알림 동의</label>
							<span class="toggle-icon">〉</span>
						</div>
						<div class="terms-box">
							<div class="terms-content">
								<p>1. 수집항목: 이메일, 휴대전화번호</p>
								<p>2. 수집목적: 신규 서비스(제품) 개발 및 마케팅, 이벤트 및 광고성 정보 제공, 인구통계학적 특성에
									따른 서비스 제공</p>
								<p>3. 보유기간: 회원 탈퇴 시 또는 동의 철회 시까지</p>

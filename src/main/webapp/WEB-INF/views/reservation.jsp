...
<form action="/reservation/submit" method="post" style="display: flex; gap: 50px;">
  ...
  <section style="flex: 1;">
    ...
    <label><input type="checkbox" required> (필수) 개인정보 수집 동의</label><br/>
    <label><input type="checkbox"> (선택) 마케팅 수신 동의</label>

    <!-- ✅ 취소 정책 -->
    <h3>취소/환불 정책</h3>
    <table border="1">
      <thead><tr><th>취소일</th><th>환불율</th></tr></thead>
      <tbody>
        <tr><td>이용 8일 전까지</td><td>총 결제금액의 100% 환불</td></tr>
        <tr><td>이용 7일 전까지</td><td>총 결제금액의 90% 환불</td></tr>
        <tr><td>이용 6일 전까지</td><td>총 결제금액의 80% 환불</td></tr>
        <tr><td>이용 5일 전까지</td><td>총 결제금액의 70% 환불</td></tr>
        <tr><td>이용 4일 전까지</td><td>총 결제금액의 60% 환불</td></tr>
        <tr><td>이용 3일 전까지</td><td>총 결제금액의 50% 환불</td></tr>
        <tr><td>이용 2일 전까지</td><td>총 결제금액의 30% 환불</td></tr>
        <tr><td>이용 1일 전까지</td><td>총 결제금액의 10% 환불</td></tr>
        <tr><td>이용 당일 및 이후</td><td>환불 불가</td></tr>
      </tbody>
    </table>

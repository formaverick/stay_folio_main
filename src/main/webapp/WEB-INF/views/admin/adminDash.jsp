...
<script>
      function scrollToCategory() {
        ...
        if (target) {
          ...
          // 기존 메뉴에서 active 제거
          document
            .querySelectorAll(".admin-nav .nav-item.active")
            .forEach((el) => {
...
<body>
	<div class="admin-container">
		...
		<aside class="admin-sidebar">
			...
			<nav class="admin-nav">
				<ul>
					<li><a href="/admin/dashboard" class="nav-item active" id="menu-dashboard">대시보드</a></li>
					...
					<li><a href="#" class="nav-item" id="menu-category" onclick="scrollToCategory()">페이지관리</a></li>
				</ul>
			</nav>
		</aside>
		...
		<main class="admin-main">
			...
			<section class="dashboard-top5">
				...
				<div class="room-table-container">
					<table class="room-table">
						...
						<tbody>
							<c:forEach var="stay" items="${topReservedStays}" varStatus="loop">
								<tr>
									<td>${loop.index + 1}</td>
			...
			<section class="dashboard-top5">
				...
				<div class="room-table-container">
					<table class="room-table">
						...
						<tbody>
							<c:forEach var="stay" items="${topBookmarkedStays}" varStatus="loop">
								<tr>
									<td>${loop.index + 1}</td>
									<td><a href="/admin/stay/detail?siId=${stay.siId}">${stay.siName}</a>
									</td>
									<td>${stay.siBook}</td>
								</tr>
							</c:forEach>
			...
			<section>
				<div class="header-content">
					...
					<div class="header-right">
						<form action="/admin/stay/staylist" method="get" style="display: inline-block; margin-right: 1rem">
							...
							<tbody>
								<c:forEach var="stay" items="${stayList}">
									<tr>
										...
										<td><a href="/admin/stay/detail?siId=${stay.siId}" class="btn-edit">상세보기</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
							...
							<tbody>
								<c:forEach var="category" items="${categoryList}">
									<tr>
										...
										<td>
											<a href="${pageContext.request.contextPath}/admin/category/detail?rcId=${category.rcId}" class="btn-edit">상세보기</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
							...
							<tbody>
								<c:forEach var="keyword" items="${keywordList}">
									<tr>
										...
										<td>${keyword.siNum}</td>
										<td>
											<a href="${pageContext.request.contextPath}/admin/keyword/detail?rcId=${keyword.rcId}" class="btn-edit">상세보기</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>

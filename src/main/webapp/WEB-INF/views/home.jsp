		...
		<div class="carousel">
			<div class="carousel-track">
				...
				<div class="carousel-slide">
					...
					<div class="carousel-content">
						<h2>
							남원 프리미엄 한옥에서<br />시원하게 즐기는 여행
						</h2>
						<p>
							오픈 기념 최대 15% 할인!<br />가족과 함께 가볍게 떠나보세요
						</p>
					</div>
				</div>
				<div class="carousel-slide">
				...
				<div class="carousel-slide">
					...
					<div class="carousel-content">
						<h2>
							노천탕이 있는 오션뷰 스테이<br />딜문 숙박권 이벤트
						</h2>
						<p>
							50만원 상당 숙박권과<br />할인쿠폰을 놓치지 마세요
						</p>
					</div>
				</div>
				<div class="carousel-slide">
					...
					<div class="carousel-content">
						<h2>
							제주 동쪽 바다를 담은<br />로망 가득한 '로메니'
						</h2>
						<p>
							노천탕, 오션뷰 다락, 빔 프로젝터 등<br />15% 할인된 가격으로 만나 보세요 보세요
						</p>
					</div>
				</div>
				<div class="carousel-slide">
					...
					<div class="carousel-content">
						<h2>
							익숙함을 벗어나<br />자연과 음악이 함께하는 곳
						</h2>
						<p>
							하늘이 열린 천창 욕조, 음악당 등<br />오픈 기념 20% 할인으로 만나 보세요
						</p>
					</div>
				</div>
				<div class="carousel-slide">
					...
					<div class="carousel-content">
						<h2>
							싱그러운 여행을 선물해요<br />꼬마 탐험가들의 영어캠프
						</h2>
						<p>
							1박 2일 영어캠프,<br />객실 및 조식 패키지
						</p>
					</div>
				</div>
			</div>

	...
	<main class="mypage-main">
		...
		<div class="mypage-page">
			...
			<div class="mypage-main">
				...
				<form id="cancelForm" action="${pageContext.request.contextPath}/mypage/reservations/${reserv.srId}/cancel" method="post">
					...
					<div class="refund-policy-section">
						<h3>환불규정</h3>
						<p class="refund-desc">※ 숙박일의 체크인일을 기준하여 일자, 양수, 금액을 조정합니다.</p>
						...
						<div class="refund-check">
							<label><input type="checkbox" name="agreement" /> 환불규정을 모두 확인하였으며 이에 동의합니다.</label>
						</div>
					</div>
